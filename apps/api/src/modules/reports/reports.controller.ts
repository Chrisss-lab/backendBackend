...
export class ReportsController {
  ...
  @Get("calculator")
  calculator() {
    return this.reports.calculatorReference();
  }

  @Get("calculator/sheet-template.csv")
  @Header("Content-Type", "text/csv; charset=utf-8")
  @Header("Content-Disposition", 'attachment; filename="hub-calculator-formulas-template.csv"')
  calculatorSheetTemplateCsv(): string {
    return this.reports.calculatorSheetTemplateCsv();
  }
}
